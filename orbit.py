...
while True:
    ...
    print(Fore.RED + 'The developer is not liable for any damage caused with this tool if used wrong.' + Style.RESET_ALL) 
    print('')
    print(Fore.MAGENTA + '[1] GitHub: https://github.com/itsbr0dyy' + Style.RESET_ALL) 
    print(Fore.MAGENTA + '[2] Website: https://itsbr0dyy.dev' + Style.RESET_ALL) 
    print(Fore.MAGENTA + '[3] API: http://ip-api.com/json' + Style.RESET_ALL) 
    print('')
    ...
    if x == '':
        ...
        print('')
        print(Fore.RED + '----------------------IP DATA-------------------------' + Style.RESET_ALL)
        print(Fore.GREEN + '')
        ...
        print(f"API: https://ip-api.com/json/{data['query']}")
